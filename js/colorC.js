...
var footer1C = document.getElementById('footer1C');
...
function Darkmode(){
    ...
    if (image.src.match("img/black/sun.png")) {
                ...
                footer1C.style.color="black"
                footer1C.style.backgroundColor="#baadad"
                footer1.style.fontWeight="600"
                ...
                footer1C.style.color="white"
                footer1C.style.backgroundColor="black"
                footer1.style.fontWeight="0"
...
var fivea = document.getElementsByClassName('5tha');
...
function colorforlight(){
    ...
    for(var i = 0; i < container.length; i++){
        ...
        container[i].style.boxShadow = "rgb(0 0 0) 0px 0px 15px 4px";
    }
    for(var i = 0; i < more.length; i++){
        more[i].style.boxShadow = "rgb(4 5 5) 0px 0px 17px 4px";
    }
}
